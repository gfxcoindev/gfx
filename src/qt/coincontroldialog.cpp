...
void CoinControlDialog::updateView()
{
    ...
    BOOST_FOREACH(PAIRTYPE(QString, vector<COutput>) coins, mapCoins)
    {
        ...
        BOOST_FOREACH(const COutput& out, coins.second)
        {
            ...
            {
                sAddress = CGraphicscoinAddress(outputAddress).ToString().c_str();
                
                // if listMode or change => show graphicscoin address. In tree mode, address is not shown again for direct wallet address outputs
